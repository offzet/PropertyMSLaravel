                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.properties.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Property Type -->
                            <div>
                                <label for="type" class="block text-sm font-medium text-gray-700">Property Type
                                    *</label>
                                <select name="type" id="type" required
                                    ...
                                    <option value="townhouse" {{ old('type') == 'townhouse' ? 'selected' : '' }}>
                                        Townhouse</option>
                                    <option value="condo" {{ old('type') == 'condo' ? 'selected' : '' }}>Condominium
                                    </option>
                            ...
                            <!-- Price -->
                            <div>
                                <label for="price" class="block text-sm font-medium text-gray-700">Price (₱/month)
                                    *</label>
