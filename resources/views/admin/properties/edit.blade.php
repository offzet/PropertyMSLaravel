                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.properties.update', $property->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Property Name -->
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-700">Property Name
                                    *</label>
                            ...
                            <div>
                                <label for="code" class="block text-sm font-medium text-gray-700">Property
                                    Code</label>
                            ...
                            <div>
                                ...
                                <select name="type" id="type" required
                                    ...
                                    <option value="house"
                                        {{ old('type', $property->type) == 'house' ? 'selected' : '' }}>House</option>
                                    <option value="townhouse"
                                        {{ old('type', $property->type) == 'townhouse' ? 'selected' : '' }}>Townhouse
                                    </option>
                                    <option value="condo"
                                        {{ old('type', $property->type) == 'condo' ? 'selected' : '' }}>Condominium
                                    </option>
                                    <option value="commercial"
                                        {{ old('type', $property->type) == 'commercial' ? 'selected' : '' }}>Commercial
                                    </option>
                                </select>
                                @error('type')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" name="price" id="price" required min="0"
                                    step="0.01" value="{{ old('price', $property->price) }}"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                                @error('price')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <div class="bg-red-50 p-4 rounded-md">
                            ...
                            <p class="text-red-600 mb-4">Once you delete a property, there is no going back. Please be
                                certain.</p>
