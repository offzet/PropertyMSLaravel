<nav x-data="{ open: false }" class="w-64 bg-white border-r border-gray-200 flex flex-col shadow-lg">
    <!-- Logo Section -->
    <div class="flex items-center justify-between h-20 px-6 border-b border-gray-100 bg-gradient-to-r from-blue-600 to-purple-700">
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" 
                        ...
                        <span class="font-medium text-gray-700 group-hover:text-blue-700">{{ __('Dashboard') }}</span>
                    </x-nav-link>
                </li>
                ...
                <li>
                    <x-nav-link :href="route('admin.properties.index')" :active="request()->routeIs('admin.properties.index')" 
                        ...
                        <span class="font-medium text-gray-700 group-hover:text-blue-700">{{ __('Properties') }}</span>
                    </x-nav-link>
                </li>
                ...
                <li>
                    <x-nav-link :href="route('admin.tenants.index')" :active="request()->routeIs('admin.tenants.index')" 
                        ...
                        <span class="font-medium text-gray-700 group-hover:text-green-700">{{ __('Tenants') }}</span>
                    </x-nav-link>
                </li>
                ...
                <li>
                    <x-nav-link :href="route('admin.repairs.index')" :active="request()->routeIs('admin.repairs.index')" 
                        ...
                        <span class="font-medium text-gray-700 group-hover:text-red-700">{{ __('Repairs') }}</span>
                    </x-nav-link>
                </li>
            </ul>
