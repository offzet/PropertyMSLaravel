        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                    ...
                    <div class="mt-2">
                        @php
                            $occupancyRate = $totalProperties > 0 ? round((($totalProperties - $availableProperties) / $totalProperties) * 100) : 0;
                        @endphp
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="{{ route('admin.properties.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                    ...
                    <a href="{{ route('admin.tenants.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                    ...
                    <a href="{{ route('admin.repairs.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                    ...
                    <a href="{{ route('admin.repairs.create') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">{{ $repair->property->name }} • {{ $repair->tenant->name }}</p>
                            </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">{{ $tenant->property->name ?? 'No Property' }} • ₱{{ number_format($tenant->rent_amount, 2) }}</p>
                            </div>
                            <span class="px-2 py-1 text-xs font-medium rounded-full 
