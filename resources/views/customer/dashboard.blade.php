...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <section class="relative py-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <!-- Floating Circles -->
            <div class="absolute top-10 left-10 w-72 h-72 bg-gradient-to-r from-blue-200 to-purple-200 rounded-full opacity-20 blur-3xl animate-pulse"></div>
            <div class="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-purple-200 to-pink-200 rounded-full opacity-15 blur-3xl animate-pulse delay-1000"></div>
            <div class="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-r from-cyan-200 to-blue-200 rounded-full opacity-25 blur-3xl animate-pulse delay-500"></div>
            
            <!-- Grid Pattern -->
            <div class="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,black,transparent)]"></div>
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    <div class="inline-flex items-center bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-blue-200 shadow-sm">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="{{ route('customer.properties.index') }}" class="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-2xl flex items-center justify-center">
                ...
                <div class="relative">
                    <!-- Main Card -->
                    <div class="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                        <!-- Property Card -->
                        <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="text-2xl font-bold text-blue-600">₱25,000<span class="text-sm text-gray-600">/month</span></div>
                    ...
                    <!-- Floating Elements -->
                    <div class="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-r from-green-400 to-cyan-400 rounded-2xl rotate-12 shadow-lg animate-float">
                        <div class="w-full h-full flex items-center justify-center text-white">
                            <i class="fas fa-star text-xl"></i>
                        </div>
                    </div>
                    
                    <div class="absolute -bottom-6 -left-6 w-20 h-20 bg-gradient-to-r from-orange-400 to-pink-400 rounded-2xl -rotate-12 shadow-lg animate-float-delayed">
                        <div class="w-full h-full flex items-center justify-center text-white">
                    ...
                    <!-- Floating Badges -->
                    <div class="absolute top-1/4 -left-8 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-gray-200 transform -rotate-6">
                        <div class="flex items-center space-x-3">
                    ...
                    <div class="absolute bottom-1/4 -right-8 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-gray-200 transform rotate-6">
                        <div class="flex items-center space-x-3">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Feature 1 -->
                <div class="group bg-gradient-to-br from-white to-blue-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-100">
                ...
                <div class="group bg-gradient-to-br from-white to-orange-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-orange-100">
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                <a href="{{ route('customer.properties.index') }}" class="group bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-gray-100">
                    <div class="w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <a href="{{ route('customer.repairs.index') }}" class="group bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-gray-100">
                    <div class="w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                        <i class="fas fa-tools text-white text-2xl"></i>
                    </div>
                ...
                <a href="#" class="group bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-gray-100">
                    <div class="w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-gray-50 rounded-2xl p-8">
                    ...
                    <p class="text-gray-600 italic">
                        "This platform made managing my rental properties so much easier. Maintenance requests get handled quickly!"
                    </p>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-600 rounded-full flex items-center justify-center text-white font-bold mr-4">
                            AL
                        </div>
                        <div>
                    ...
                    <p class="text-gray-600 italic">
                        "This system has streamlined our operations significantly. Our tenants are happier and our team is more efficient."
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-bold mb-6">Ready to Book Your Property?</h2>
            <p class="text-xl text-blue-100 mb-8">
                Join thousands of satisfied customers and experience the difference today.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('customer.properties.index') }}" class="bg-white text-blue-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105">
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2024 PropertyManager. All rights reserved. Making property management simple and efficient.</p>
            </div>
        </div>
    </footer>
