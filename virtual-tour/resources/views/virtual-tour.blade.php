...
<html lang="en">
<head>
    <!--projecttitle--><title>Virtual Tour</title><!--projecttitle-end-->
    <!--projectdescription--><meta name="description" content="Project 3Sixty Virtual Tour"><!--projectdescription-end-->
    ...
    <!-- ✅ Correct JS paths -->
    <script src="{{ asset('virtual-tour/js/jquery.js') }}"></script>
    <script src="{{ asset('virtual-tour/js/imagedata.js') }}"></script>
    ...
    <style>
        ...
        ::-webkit-scrollbar-track { background: #2c3643; }
        ::-webkit-scrollbar-thumb { background: #0d9e59; transition: background .5s; }
        ::-webkit-scrollbar-thumb:hover { background: #00e075; }
...
<body id="body">
    ...
    <script src="{{ asset('virtual-tour/js/three.min.js') }}"></script>
    <script src="{{ asset('virtual-tour/js/OrbitControls.js') }}"></script>
    ...
    <script>
        ...
        function init() {
            ...
            const texture = new THREE.TextureLoader().load("@php echo asset('virtual-tour/panoramas/testpanorama.jpg'); @endphp");
        ...
        function loadHotspotsFor(panorama) {
            ...
            if (panorama === 'testpanorama.jpg') {
                addHotspot("@php echo asset('virtual-tour/images/default.png'); @endphp",  new THREE.Vector3(-292.12, 170.66, 212.67), () => {
                    switchPanorama('testpanorama74hYy.jpg');
                });
            }

            if (panorama === 'testpanorama74hYy.jpg') {
                addHotspot("@php echo asset('virtual-tour/images/default.png'); @endphp", new THREE.Vector3(9.52, -108.61, -383.97), () => {
                    switchPanorama('testpanorama.jpg');
                });
            }
        }
        ...
        const newTexture = new THREE.TextureLoader().load(`@php echo asset('virtual-tour/panoramas'); @endphp/${panoramaName}`, (tex) => {
        ...
        function addHotspot(imageUrl, position, onClickCallback) {
            ...
            textureLoader.load(imageUrl, (texture) => {
                ...
                sprite.userData = { onClick: onClickCallback, targetScale: 40 };
        ...
        function onPointerMove(event) {
            ...
            spriteHotspots.forEach(sprite => sprite.userData.targetScale = 40);
